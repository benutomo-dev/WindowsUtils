...
";
        ...
        static void Main(string[] args)
        {
            ...
            using (var gothicFont = new Gdi32Font("MS UI Gothic", FontSizeUnit.Pixel, size, FontWeightConsts.FW_NORMAL, false, false, false, 1, Gdi32FontQuality.Default))
            {
                ...
                RenderSvgSample("僅", size, origin, ipaFont, htmlBuilder);
                RenderSvgSample("僅󠄀", size, origin, ipaFont, htmlBuilder);
                RenderSvgSample("僅󠄁", size, origin, ipaFont, htmlBuilder);
                RenderSvgSample("僅󠄂", size, origin, ipaFont, htmlBuilder);
                RenderSvgSample("僅󠄃", size, origin, ipaFont, htmlBuilder);
                ...
                RenderSvgSample("僅", size, origin, msMinchoFont, htmlBuilder);
                RenderSvgSample("僅󠄀", size, origin, msMinchoFont, htmlBuilder);
                RenderSvgSample("僅󠄁", size, origin, msMinchoFont, htmlBuilder);
                RenderSvgSample("僅󠄂", size, origin, msMinchoFont, htmlBuilder);
                RenderSvgSample("僅󠄃", size, origin, msMinchoFont, htmlBuilder);
